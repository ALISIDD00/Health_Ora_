...
<div class="page-banner overlay-dark bg-image" style="background-image: url(../layouts/Customer/assets/img/homebg.png);">
      ...
      <div class="container text-center wow fadeInUp">
        <nav aria-label="Breadcrumb">
          <ol class="breadcrumb breadcrumb-dark bg-transparent justify-content-center py-0 mb-2">
            ...
            <li class="breadcrumb-item active" aria-current="page">Fitnessprogram</li>
          </ol>
        </nav>
        <h1 class="font-weight-normal">Fitness Program</h1>
      </div> <!-- .container -->
    </div> <!-- .banner-section -->
  </div> <!-- .page-banner -->
    ...
    <div class="container rr">
        ...
        <section class="sectionn" id="youth">
            ...
            <a class="aa" href="<?php echo "http://localhost/Health_Ora/services/Fitnessprogram/Youth.php" ?>">Get Started</a>
        </section>
        ...
        <section class="sectionn" id="adults">
            ...
            <a class="aa" href="<?php echo "http://localhost/Health_Ora/services/Fitnessprogram/Adult.php" ?>">Get Started</a>
        </section>
        ...
        <section class="sectionn" id="seniors">
            ...
            <a class="aa" href="<?php echo "http://localhost/Health_Ora/services/Fitnessprogram/Senior.php" ?>">Get Started</a>
        </section>
